...
public interface RmiAwareConstants extends BaseConstants {
    String RMI_PROVIDER_TYPE = "griffon.plugins.rmi.RmiProvider";
    String DEFAULT_RMI_PROVIDER_TYPE = "griffon.plugins.rmi.DefaultRmiProvider";
    String RMI_CONTRIBUTION_HANDLER_TYPE = "griffon.plugins.rmi.RmiContributionHandler";
    String RMI_PROVIDER_FIELD_NAME = "this$rmiProvider";
    String METHOD_GET_RMI_PROVIDER = "getRmiProvider";
    String METHOD_SET_RMI_PROVIDER = "setRmiProvider";
